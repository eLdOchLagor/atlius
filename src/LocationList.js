...
return(
    // TODO: Om sökrutan ej är markerad, visa ej listan
    // TODO: Slicea listan till maxantal
<div className="App">
    <input id="input" type="text" placeholder="Type here..." onChange={changeInput}/>
    {resultList.map((input) => (
    <LocationInfo key={input.room} data={input}/>
    ))
    }
    <img src={TP_4} placeholder="logo"></img>
</div>
)}
